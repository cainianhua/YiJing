<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/Admin.Master" ValidateRequest="false" AutoEventWireup="false" CodeBehind="AddText.aspx.cs" Inherits="YiJingWebUI.Admin.Settings.EditWords" %>
