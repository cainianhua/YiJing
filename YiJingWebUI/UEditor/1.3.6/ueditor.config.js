...
(function () {
	...
	*/
	window.UEDITOR_CONFIG = {
        ...
        , snapscreenServerUrl: URL + "api/imageUp.ashx" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        , snapscreenPath: URL + "net/"
        , snapscreenServerPort: location.port                                   //屏幕截图的server端端口
		//,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

		//word转存配置区
        , wordImageUrl: URL + "api/imageUp.ashx"             //word转存提交地址
        , wordImagePath: URL + "net/"                       //
		//,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

		//视频上传配置区
        , getMovieUrl: URL + "api/getMovie.ashx"                   //视频数据获取地址
        , videoUrl: URL + "api/fileUp.ashx"               //附件上传提交地址
