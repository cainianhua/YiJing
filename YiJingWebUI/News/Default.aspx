<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="false" CodeBehind="Default.aspx.cs" Inherits="YiJingWebUI.News.Default" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="FooterScripts" runat="server">
	...
	<script type="text/javascript">
		//新闻列表hover效果
		$('.box-listnews .bd li').hover(function () {
			$(this).toggleClass('on');
		});
		//瀑布流
